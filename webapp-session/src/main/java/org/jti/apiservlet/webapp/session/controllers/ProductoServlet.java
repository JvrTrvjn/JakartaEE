...
import org.jti.apiservlet.webapp.session.services.*;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.setContentType("text/html;charset=UTF-8");
                try(PrintWriter out = resp.getWriter()){
                    ...
                    usernameOptional.ifPresent(s -> out.println("       <h3 style='color:blue;'>Hola " + s + "</h3>"));
                    out.println("       <table>");
                    out.println("           <tr>");
                    ...
                    out.println("<p><a href='"+ req.getContextPath() + "/index.html'>Logout</a></p>");
                    out.println("   </body>");
                    out.println("</html>");
    }
}}
